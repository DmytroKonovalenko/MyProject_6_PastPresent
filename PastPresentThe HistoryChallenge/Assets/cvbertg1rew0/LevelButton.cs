...
public class LevelButton : MonoBehaviour
{
    ...
    public void SetPilotInfo(string name, Sprite pilotSprite, Sprite newRank)
    {
        pilotName = name;
        pilotImage = pilotSprite;
        rankImage = newRank;
    }
    ...
    {
        return currentStatus != LevelStatus.Locked;
    }
}
